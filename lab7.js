...
ctForm.addEventListener("submit", (e) => {
    ...
    if (!name) {
        ctFeedback.textContent = "Please enter your name.";
        ctFeedback.className = "feedback error"; ctName.focus(); return;
    }
    if (!isLikelyEmail(fromEmail)) {
        ctFeedback.textContent = "Please enter a valid email address."; ctFeedback.className = "feedback error"; ctEmail.focus(); return;
    }
    if (!subj) {
        ctFeedback.textContent = "Please enter a subject.";
        ctFeedback.className = "feedback error"; ctSubject.focus(); return;
    }
    if (!msg) {
        ctFeedback.textContent = "Please enter a message."; ctFeedback.className
